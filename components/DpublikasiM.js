...
export default function DpublikasiM({ title }) {
  return (
    <div className="">
      <Menu as="div" className="inline-block text-left">
        <div>
          <Menu.Button className=" text-slate-900 dark:text-slate-50  inline-flex w-full justify-center rounded-md px-4 py-2 text-sm font-medium">
            {title}
