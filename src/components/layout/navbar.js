...
export default function Navbar() {
  ...
  return (
    <section>
      ...
      <Disclosure
        as="nav"
        className="backdrop-blur-sm  shadow-gray-200 dark:shadow shadow-md fixed z-[999] w-full top-0"
        style={{
            ...
            <div className="relative flex h-16 items-center justify-between">
              ...
              <div className="flex flex-1  items-center justify-self-center justify-center lg:justify-between">
                <div className="flex justify-center items-center">
                  ...
                  <div className="ml-8 m-auto hidden lg:flex space-x-8 justify-center place-items-center">
                    {navigation.map((e, i) => (
                      <Link
                        key={i}
                        href={e.href}
                        className={
                          route.pathname === e.href
                            ? `underline-offset-8 underline rounded-lg font-semibold`
